...
public:
    ...
    enum class ShowMode { WoodCrate, FireAnim ,MyBox};
...
private:
    ...
    ComPtr<ID3D11ShaderResourceView> m_pMyBox;                  // alt
    ComPtr<ID3D11ShaderResourceView> m_pFlareAlpha;             // alt
